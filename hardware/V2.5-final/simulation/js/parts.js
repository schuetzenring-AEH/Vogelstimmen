/**
 * Datenblatt-Parameter Vogelstimmenkasten Rev 2.5
 * Quellen: docs/datasheets/* (Stand 2026-08)
 */
...
export const PARTS = {
  R1: { ref: "R1", kind: "R", value: "100k", package: "0402", model: "ohmic", R: 100e3, note: "Q1 Gate Pull-up", source: "BOM" },
  R2: { ref: "R2", kind: "R", value: "100k", package: "0402", model: "ohmic", R: 100e3, note: "Q2 Gate Pull-down", source: "BOM" },
  R3: { ref: "R3", kind: "R", value: "10k", package: "0402", model: "ohmic", R: 10e3, note: "BUSY/CON3 Pull-down Mode 0", source: "DY-SV17F" },
  R4: { ref: "R4", kind: "R", value: "10k", package: "0402", model: "ohmic", R: 10e3, note: "Selbsthaltung", source: "E-LATCH" },
  R5: { ref: "R5", kind: "R", value: "0R", package: "0402", model: "ohmic", R: 0, note: "TPS62163 VOS direkt 5V (F-02)", source: "TI DS" },
  R12: { ref: "R12", kind: "R", value: "10", package: "0402", model: "ohmic", R: 10, note: "LED-Strombegrenzung 12V_LED (F-04)", source: "Respin" },
  R13: { ref: "R13", kind: "R", value: "100k", package: "0402", model: "ohmic", R: 100e3, note: "BUSY -> Q3_GATE RC (F-03)", source: "Respin" },
  R6: { ref: "R6", kind: "R", value: "470k", package: "0402", model: "ohmic", R: 470e3, note: "Q5 Gate->GND Idle ~12 uA", source: "E-RPP-01" },
  R7: { ref: "R7", kind: "R", value: "4.7k", package: "0402", model: "ohmic", R: 4.7e3, note: "Serie Gate Q5", source: "E-VGS-01" },
  R8: { ref: "R8", kind: "R", value: "4.7k", package: "0402", model: "ohmic", R: 4.7e3, note: "Serie Gate Q1", source: "E-VGS-01" },
  R9: { ref: "R9", kind: "R", value: "10k", package: "0402", model: "ohmic", R: 10e3, note: "Pull-up BTN_OR", source: "E-LATCH-02" },
  R10: { ref: "R10", kind: "R", value: "1k", package: "0402", model: "ohmic", R: 1e3, note: "Serie SET", source: "E-LATCH-02" },
  R11: { ref: "R11", kind: "R", value: "4.7k", package: "0402", model: "ohmic", R: 4.7e3, note: "Serie Gate Q6", source: "E-LATCH-02" },
  ...
  D10: { ref: "D10", kind: "D", value: "1N4148WS", package: "SOD-323", lcsc: "C118873", model: "diode", Vf: 0.7, Ileak: 25e-9, note: "Freilauf Kuebler", source: "onsemi" },
  ...
  J5: { ref: "J5", kind: "CNT", value: "K07.90", package: "THT", model: "counter", note: "1.130.900.008 4.5V/10Hz P~50mW", source: "Kuebler K04-K07" },
};

/** Rcoil aus 50 mW @ 4.5 V */
export const KUEBLER_Rcoil = (4.5 * 4.5) / 0.05;
