...
export const BLOCKS = {
  ...
  B3: {
    ...
    detail:
      "Das Audio‑Modul und der Kübler‑Zähler brauchen 5 V, die Batterie liefert 12 V. Ein linearer Regler würde die Spannungsdifferenz als Wärme vernichten. Der Schaltregler (Buck) TPS62163 taktet stattdessen mit hoher Frequenz und speichert Energie in Spule L1 — typisch mit Wirkungsgraden um 90 %.\n\n" +
  ...
  B5: {
    ...
    name: "Impulszähler",
    task:
      "Zählt jedes Aufwachen der Box mechanisch mit (Kübler K07.90). Die Spule liegt an der 5‑V‑Schiene und erhält damit genau dann einen Impuls, wenn Latch und Buck aktiv werden.",
    detail:
      "Statt Software‑Zähler nutzen wir einen elektromechanischen Printzähler. Beim Anlegen von Spannung zieht eine Spule den Zählmechanismus um eine Stelle weiter. Weil 5 V nur existiert, solange gespielt (bzw. die Box wach) ist, entspricht jeder Power‑Zyklus typischerweise +1.\n\n" +
      "Bestellt ist der 4,5‑V‑/10‑Hz‑Typ (1.130.900.008); er läuft an unserer 5‑V‑Schiene innerhalb der Hersteller‑Toleranz (−10 %/+20 % bei Typ 0). Die Leistungsaufnahme der Spule liegt laut Datenblatt bei etwa 50 mW → rund 12 mA bei 5 V.\n\n" +
      "Diode D10 liegt als Freilauf parallel zur Spule: Beim Abschalten verhindert sie die induktive Spannungsspitze, die sonst Halbleiter auf der 5‑V‑Schiene gefährden könnte.",
  },
  B6: {
    id: "B6",
...
export const META = {
  ...
  C3: {
    block: "B3", kind: "C",
    role: "Ausgangskondensator der 5‑V‑Schiene: glättet die Buck‑Welligkeit für Audio‑Modul und Zähler.",
    detail:
      "Am Buck‑Ausgang glättet C3 (22 µF/10 V) die Sägezahn‑Welligkeit der Spulenstrom‑Umsetzung. Audio‑Elektronik ist empfindlich gegen Supply‑Noise; ausreichend COUT ist Teil der TI‑Empfehlung.",
  ...
  D10: {
    block: "B5", kind: "D",
    role: "Freilaufdiode parallel zur Zählerspule: nimmt den Induktionsstrom auf, wenn die 5‑V‑Versorgung abgeschaltet wird.",
    detail:
      "Eine Spule speichert magnetische Energie. Beim Trennen der Spannung will der Strom weiterfließen und erzeugt sonst eine hohe Gegenspannung. D10 bietet einen Pfad (Kathode an 5 V, Anode an Spulen‑Masse‑Seite), sodass die Energie kontrolliert abklingt, statt Halbleiter zu zerstören.",
    limits: { Vmax: 75, Imax: 0.15 },
  },
  D13: {
    block: "B2", kind: "D",
  ...
  U1: {
    block: "B3", kind: "IC",
    role: "TPS62163: synchroner 1‑A‑Buck mit fester 5‑V‑Ausgangsspannung, speist Audio und Zähler aus 12V_SW.",
    detail:
      "Eingangsbereich 3…17 V, typischer Ruhestrom im Power‑Save ~17 µA (nur relevant wenn EN aktiv). Festspannungsvariante, FB intern verdrahtet. In dieser Box ist EN = 12V_SW: kein Betrieb im Batterie‑Idle. Die Simulation ersetzt den Chip durch Wirkungsgrad‑ und Strombilanz‑Verhalten.",
  ...
  J5: {
    block: "B5", kind: "CNT",
    role: "Kübler K07.90 (Bestellnr. 1.130.900.008): 7‑stelliger elektromechanischer Zähler, Anzeige nach oben, Spule an 5 V.",
    detail:
      "Jeder Versorgungszyklus der 5‑V‑Schiene erzeugt typischerweise einen Zählimpuls. Nennspannung 4,5 V DC, 10 Hz‑Typ, Leistungsaufnahme ~50 mW. An 5 V betrieben innerhalb der angegebenen Toleranz. Mechanik und Anzeige sind wartungsfrei für den Lehrpfad‑Einsatz gedacht.",
    limits: { Vnom: 4.5, Vtol: [4.05, 5.4], Ityp: 0.0123, Ptyp: 0.05 },
  },
  ...
  TP2: {
    block: "B3", kind: "TP",
    role: "Messpunkt 5 V — Buck‑Ausgang für Modul und Zähler.",
    detail: "Nur bei aktivem Latch ≈5,0 V. Im Idle 0 V — so prüft man, ob Ein‑/Ausschalten funktioniert.",
    limits: { Vmax: 6 },
  },
  TP3: {
    block: "B1", kind: "TP",
