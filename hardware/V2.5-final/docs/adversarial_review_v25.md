# Adversarial Hardware Review — Rev 2.5

**Rolle:** Senior Hardware / PCB Reviewer (Widerlegung, nicht Bestätigung)  
**Datum:** 1. August 2026  
**Quellen:** `vogelstimmen_v2.5.kicad_sch/pcb`, `docs/schaltplan.md`, TI SLVSAM2, Kübler/SI2301-Annahmen, **V2.5-final** Fertigpaket
...
**Respin-Status:** F-01…F-05 im Working-PCB (`vogelstimmen_v2.5.*`). DRC **0** Fehler / **0** unverbunden; ERC **0** Fehler; Schaltplan-Parität OK. Fertigungspaket **V2.5-final/** exportiert 03.08.2026.
...
**Disposition (03.08.2026):** Modul auf **Sockel** — IBN-Regel: *USB nur zum Programmieren, Modul abgezogen oder Latch aus (kein 12V_SW)*.
