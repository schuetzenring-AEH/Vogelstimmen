# Schaltplan: Vogelstimmenkasten Rev 2.5 (Respin + GND-Vias)

**Architektur:** DY-SV17F + Latch-Schaltung + TPS62163 Buck  
**Basis:** `docs/systemarchitektur.md`, `docs/anforderungen.md`  
**KiCad:** `vogelstimmen_v2.5.kicad_sch` / `.kicad_pcb`  
**Datum:** 3. August 2026 (Rev 2.5)
...
Details: `docs/adversarial_review_v25.md`, `docs/entscheidungen.md` E-RESPIN-01.
