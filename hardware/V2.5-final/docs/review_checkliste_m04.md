...
**Stand Vorlage:** 1. August 2026 · Rev **2.5**  
**Fertigungsdaten:** `V2.5-final/` (dieses Paket)

> Reviewer: Kästchen abhaken. Offene Punkte in die Spalte „Notiz“. Am Ende Signatur.  
> **Adversarial Review:** F-01…F-09 geschlossen (03.08.2026) — Respin F-01…F-05 + F-06…F-09 dispositioniert; siehe [`adversarial_review_v25.md`](adversarial_review_v25.md). Gerber exportiert 03.08.2026; Proto optional (F-03/F-04/F-08).
...
| # | Prüfpunkt | OK | Notiz |
|---|-----------|:--:|-------|
| C1 | KiCad-Projekt `vogelstimmen_v2.5.kicad_pro` öffnet Schaltplan + PCB | ☐ | |
...
1. JLCPCB: `vogelstimmen_v2.5-Gerber.zip` (+ optional BOM/CPL)  
