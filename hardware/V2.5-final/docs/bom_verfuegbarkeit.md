...
**Datum:** 3. August 2026  
**Status:** Rev 2.5 · Respin F-01…F-05 + GND-Vias; BOM `JLCPCB_BOM.csv`
...
Diese Teile stehen **nicht** in `JLCPCB_BOM.csv` / CPL. Liste: **`HAND_BESTUECKUNG.csv`**.

| Bauteil | Quelle | Assembly |
|---------|--------|----------|
| DY-SV17F U2 | AliExpress / eBay | HAND |
| Kübler 1.130.900.008 | Fachhandel | HAND |
...
| Datei | Inhalt |
|-------|--------|
| `JLCPCB_BOM.csv` | nur SMT (`Mount=SMT`) |
| `HAND_BESTUECKUNG.csv` | nur HAND / DNP |
