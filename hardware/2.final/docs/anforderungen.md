...
| ID | Anforderung | Priorität |
|----|-------------|-----------|
| H01 | Elektromechanischer Impulszähler (Printzähler, 5V DC, 7-stellig, von vorne ablesbar) direkt auf der Platine montiert | Muss |
...
| H06 | Zähler von oben ablesbar (K07.90, Anzeige oben; Sichtfenster im Gehäuse) | Muss |
...
| Impulszähler | 5V DC Printzähler, direkt auf PCB gelötet | Lötstifte (integriert) |
