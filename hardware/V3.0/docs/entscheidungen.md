...
## E-LATCH-02 — Kaltstart-SET mit P-FET (v2.5), nicht N-FET-Inverter

**Datum:** 31.07.2026  
**Status:** gültig (ab PCB **v2.5** / Doku Rev 2.5)  
...
**Siehe:** `docs/pcb_v2.5.md`, `docs/schaltplan.md` B2, `docs/digitaler_zwilling.md`
...
**Status:** gültig (Working-PCB + Schaltplan Rev 2.5r)
...
**Referenz:** `docs/adversarial_review_v25.md` (Respin-Skripte im Repo unter `hardware/`)
...
**Referenz:** `docs/adversarial_review_v25.md` Dispositionstabelle
