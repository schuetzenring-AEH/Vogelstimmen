...
export const BLOCK_INNER = {
  ...
  B2: {
    ...
    interfaces: [
      ...
      { dir: "out", name: "12V_SW", via: "→ B3, B5, B8, R4", note: "geschaltete 12‑V‑Leistung" },
    ],
  },
  B3: {
    ...
    interfaces: [
      ...
      { dir: "out", name: "5V", via: "→ B4", note: "fest 5,0 V / bis 1 A (nur Audio)" },
    ],
  },
  B4: {
  ...
  B5: {
    title: "Funktion innerhalb B5 — One-Shot → Hengstler",
    nodes: [
      { id: "sw", label: "12V_SW\nvon B2", x: 40, y: 70, port: "in" },
      { id: "c20", label: "C20\n1µF\nKopplung", x: 120, y: 30 },
      { id: "r20", label: "R20\n100k\nEntlade", x: 120, y: 120 },
      { id: "d23", label: "D23\nClamp", x: 180, y: 150 },
      { id: "r21", label: "R21\n100Ω", x: 200, y: 70 },
      { id: "q7", label: "Q7\nAO3400\nLow-Side", x: 280, y: 70 },
      { id: "j5", label: "J5\n0.635.128\nSpule", x: 370, y: 40 },
      { id: "d10", label: "D10\nFreilauf", x: 370, y: 120 },
      { id: "disp", label: "Anzeige\n6 Digits", x: 460, y: 40, port: "out" },
    ],
    edges: [
      ["sw", "c20", "Rising"],
      ["c20", "r21", "CNT_PULSE"],
    ...
    interfaces: [
      { dir: "in", name: "12V_SW", via: "B2", note: "Rising-Edge startet ~80 ms-Puls" },
      { dir: "out", name: "Ziffernanzeige", via: "Sichtfenster", note: "1 Count / Latch-ON" },
    ],
  },
  B6: {
