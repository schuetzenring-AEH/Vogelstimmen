 ...
 * Laufzeit: identisch zu ../js/parts.js
 */
...
export const PARTS = {
  ...
  R21: { ref: "R21", kind: "R", value: "100R", package: "0603", lcsc: "C22775", model: "ohmic", R: 100, note: "One-Shot Serie Gate Q7 (E-CNT-03)", source: "V3.0" },
  ...
  C20: { ref: "C20", kind: "C", value: "1uF/50V", package: "0603", lcsc: "C15849", model: "cap", C: 1e-6, note: "One-Shot Kopplung 12V_SW→CNT_PULSE (E-CNT-03)", source: "V3.0" },
