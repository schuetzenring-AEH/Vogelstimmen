...
Interaktive **Rev-3.0**-Simulation: Taster drücken → Phasenablauf (inkl. Zähler-One-Shot) → Spannungen/Ströme pro Bauteil auf dem Platinen-Abbild.
...
| `pcb_layout.json` | Footprint-Positionen aus KiCad **V3.0** |
...
Siehe `docs/datasheets/`, `hardware/V3.0/docs/` und Parameter in `js/parts.js`.
