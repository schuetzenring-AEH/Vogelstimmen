# Zwischenstand: Vogelstimmenkasten Rev 3.0

**Datum:** 13. August 2026  
**Status:** **Rev 3.0 fertig zum Ordern** — Gerber/BOM/CPL in `hardware/V3.0/`; One-Shot-Symbole im Schaltplan; Proto-Messungen noch offen  
...
- 8 IO-Trigger, 5W Class-D Verstärker eingebaut, USB Drag&Drop (**nur Werkstatt**, E-AUDIO-04)
- Mode 0 (Flanken-Trigger) — Sound spielt nach kurzem Druck komplett durch
- **Sockel Pflicht** — Modul nicht direkt auflöten
...
- Entscheidungstabelle: `docs/entscheidungen.md` (Audio/Latch/Buck/USB) + `hardware/V3.0/docs/entscheidungen_v30.md` (Zähler/0603)
...
- TPS62163, VIN/EN = `12V_SW`, 5 V nur U2 (E-BUCK-01)
- **Kein UVLO-Teiler** am EN (E-UVLO-01)
...
- **DY-SV17F:** Sockel; USB bei **offenem Gehäuse** erreichbar (Werkstatt). Im Wald **kein** USB-Loch (E-AUDIO-04).
