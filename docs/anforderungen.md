...
|---|-----------------|----------------|
| 1 | U4 (TPS62203) und U5 (SGM809) verbrannt — nur bis 6V spezifiziert, aber an 12V angeschlossen | Buck mit VIN bis 17V (TPS62163); **kein** UVLO-IC und **kein** EN-Teiler (E-UVLO-01) |
...
| H03 | Manuell bestückt werden nur: THT-Schraubklemmen (MPT), **U2-Sockel +** DY-SV17F-Modul, Printzähler | Muss |
...
| Audio-Upload | USB Micro am DY-SV17F — Drag & Drop wie USB-Stick (kein Programmer nötig). **Nur Werkstatt:** Gehäuse auf, Latch aus oder Modul vom Sockel (E-AUDIO-04). Kein Gehäuseloch im Wald. | Micro-USB-Buchse am Modul |
...
- Tiefentladeschutz: bewusst entfallen (**E-UVLO-01**; Idle ~12 µA; internes UVLO des Buck nur als IC-Notfall, keine 10,5 V-Schwelle)
