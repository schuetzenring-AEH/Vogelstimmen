...
| A2 | Designentscheidungen in `entscheidungen.md` + `entscheidungen_v30.md` akzeptiert (inkl. E-AUDIO-04 Sockel/USB, E-UVLO-01, E-CNT-03/04) | ☐ | |
...
| B6 | Hengstler `0.635.128` + One-Shot an 12V_SW (E-CNT-03/04); nicht 5 V-Typ | ☐ | |
...
| C5 | DY-SV17F USB / Hengstler Anzeige / M3-Löcher / Testpunkte vorhanden | ☐ | |
...
| D3 | Manuelle Teile: DY-SV17F **+ Sockel (Pflicht)**, Hengstler 0.635.128, MPT 8×2 + 2×3 | ☐ | |
...
| G2 | One-Shot ~80 ms / Hengstler 12 V an 12V_SW (Kübler gestrichen) | ☐ akzeptiert | |
