# Use Cases & Szenarien — Vogelstimmenkasten Rev 2.5
...
| 3 | System | Buck → 5 V; Modul bootet; Zählerimpuls |
...
1. Latch AUS oder Modul vom Sockel nehmen.  
2. USB am DY-SV17F → Drag&Drop MP3/WAV (`00001`…`00008`).  
3. Trennen, Modul einsetzen → UC-01 testen.
