...
| F10 | Impulszähler zählt Sessions | B5 | Hengstler + One-Shot an 12V_SW | V-FUN |
...
| H01 | Printzähler 12V DC auf PCB | B5 | Hengstler 0.635.128 | V-INS |
...
| H06 | Zähler von oben ablesbar (Hengstler) | B5, PCB | Layout-Constraint | V-INS |
...
| SF-03 | Versorgungsspannung bereitstellen | 12 V auf 5 V wandeln **nur für das Audio-Modul (U1)**; Zähler speist sich aus 12V_SW |
...
| H01 | Printzähler 12V DC auf PCB | SF-07 |
...
| H06 | Zähler von oben ablesbar (Hengstler) | SF-07 |
...
| SF-07 | Nutzung zählen | B5 | Hengstler 0.635.128 + One-Shot |
