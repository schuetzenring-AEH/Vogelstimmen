# MBSE / V-Modell — Abdeckungskarte Vogelstimmen Rev 3.0
...
| E/E Schaltplan PCB | **vorhanden** | `hardware/V3.0/docs/schaltplan.md`, KiCad V3.0 | |
...
| Fertigung Gerber/BOM | **vorhanden** | `hardware/V3.0/` | |
