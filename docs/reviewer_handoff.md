# Reviewer-Handoff — vor Fertigung (Rev 3.0)
...
2. Spannungsfestigkeit / VGS-Schutz / Hengstler One-Shot an 12V_SW
3. BOM + Verfügbarkeit + manuelle Teile
4. PCB/DRC/ERC und Fertigungsdaten in `hardware/2.final/`
...
> **Adversarial Review:** [`adversarial_review_v24.md`](adversarial_review_v24.md) — **F-01…F-09 geschlossen** (03.08.2026): Respin F-01…F-05 + F-06…F-09 dispositioniert. Proto optional (F-03/F-04/F-08).  
> **Fertigung:** `hardware/2.final/` ist **Pre-Respin** — vor Bestellung neu exportieren.
...
| 2 | Cursor-Canvas **fertigung-readiness-v24** (neben Chat öffnen) | Gate-Status, Risiken, Sign-off-Überblick |
| 3 | [`zwischenstand.md`](zwischenstand.md) | Aktueller Projektstatus |
| 4 | [`anforderungen.md`](anforderungen.md) | Lastenheft F/E/H/U/M |
| 5 | [`entscheidungen.md`](entscheidungen.md) + [`hardware/V3.0/docs/entscheidungen_v30.md`](../hardware/V3.0/docs/entscheidungen_v30.md) | Latch/Audio/Buck/USB; Rev 3.0 Zähler/0603 |
| 6 | [`systemarchitektur.md`](systemarchitektur.md) | BDD / IBD / Timing |
| 7 | [`schaltplan.md`](schaltplan.md) + PDF in `hardware/2.final/` | Blöcke B1–B8 |
| 8 | [`pcb_v2.4.md`](pcb_v2.4.md) + PCB-PDF | Layout-Constraints |
...
| 13 | `hardware/2.final/` | Gerber, BOM, CPL, DRC/ERC |

KiCad öffnen: `hardware/vogelstimmen_v2.4.kicad_pro`  
...
8 beleuchtete Taster → Hardware-Latch weckt 12 V-Schiene → Buck 5 V → DY-SV17F spielt Vogelstimme → BUSY schaltet Latch ab; Idle-Elektronik ~12 µA (R6); Hengstler zählt Sessions per One-Shot.
...
| Artefakt | Pfad |
|----------|------|
| Gerber-ZIP (Upload) | `hardware/2.final/vogelstimmen_v2.4-Gerber.zip` |
| SMD-BOM LCSC | `hardware/2.final/JLCPCB_BOM.csv` |
| CPL | `hardware/2.final/vogelstimmen_v2.4-cpl.csv` |
| Schaltplan/PCB PDF | `hardware/2.final/*-schematic.pdf`, `*-pcb.pdf` |
| Gesamtpaket | `hardware/2.final.zip` |
| Anleitung Paket | `hardware/2.final/README.md` |

### Manuell (nicht JLCPCB-SMD)

- DY-SV17F auf **Sockel** (Pflicht, E-AUDIO-04)
