# Dokumentation – Vogelstimmenkasten Rev 2.5
...
| **[../mbse/](../mbse/)** | Impact-Analyse, Audit, Export (`/mbse/`) |
...
| [entscheidungen.md](entscheidungen.md) | ADRs |
...
| Dokument | Inhalt |
|----------|--------|
| [schaltplan.md](schaltplan.md) | Schaltplan-Blöcke, Netze, BOM-Link |
| [bom_verfuegbarkeit.md](bom_verfuegbarkeit.md) | LCSC / BOM-Gate M01 |
| [digitaler_zwilling.md](digitaler_zwilling.md) | Verhaltens-Twin |
...
| [../hardware/V2.5-final/docs/adversarial_review_v25.md](../hardware/V2.5-final/docs/adversarial_review_v25.md) | Adversarial Review Rev 2.5 |
...
| [../hardware/V2.5-final/](../hardware/V2.5-final/) | Gerber, BOM, CPL, PDFs, KiCad |
...
| [datasheets/](datasheets/) | Datenblätter |
