# KiCad PCB Rev 2.4 — Latch Kaltstart ≈0 µA

**Projekt:** `hardware/vogelstimmen_v2.4.kicad_pro`  
**Schaltplan:** `hardware/vogelstimmen_v2.4.kicad_sch`  
**PCB:** `hardware/vogelstimmen_v2.4.kicad_pcb`  
**Basis:** `vogelstimmen_v2.3.kicad_pcb`  
**Designentscheidung:** `docs/entscheidungen.md` → E-LATCH-02  
**Stand:** 3. August 2026 — Respin F-01…F-05 im Working-PCB; `2.final/` noch Pre-Respin
...
`hardware/2.final/` — **noch Pre-Respin**; vor Bestellung Gerber/BOM/PDF aus aktuellem Working-PCB neu exportieren.
...
1. Projekt öffnen → `vogelstimmen_v2.4.kicad_pro` (Schaltplan + PCB)
